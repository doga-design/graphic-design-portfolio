...
- My selected work includes Bountt, a shipped live React-based expense app I designed and built solo to remove financial tension from shared expenses.
...
- Bountt won an Applied Arts Magazine 2026 Student Award in the Apps, Single category (WS/01). The winning entry is Bountt App by Doga Cimen, winner number S-158. Applied Arts Magazine is Canada's leading creative industry publication, and its annual Student Awards recognize the strongest student work across the country. The work will be published in the Winter 2026 Awards Annual, mailed nationally in December 2026, and featured in the online Winners Gallery. If someone asks about Bountt's award from the Bountt case study page, use this award information as part of the Bountt project context.
