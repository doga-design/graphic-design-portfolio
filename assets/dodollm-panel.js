(function initDodoLLMPanel() {
  ...
  function buildInfoDisclaimerMarkup() {
    return `dodoGPT is an AI chatbot powered by <span class="dodollm-info-disclaimer__openai">${OPENAI_ICON_SVG}OpenAI</span>'s GPT-4o. Chats may be stored to improve the site. May contain hallucinations.`;
  }
  ...
  const SESSION_STORAGE_KEY = "dodollm.chatSessionId";
